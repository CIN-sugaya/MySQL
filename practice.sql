...
FROM
 countries
WHERE
 code IN ('DZA', 'ALB') AND indep_year < 1990;
...
SELECT
  ...
  (SELECT countries.name FROM countries WHERE countries.code = celebrities.country_code) AS countly_name
FROM
  celebrities;
...
SELECT
  ...
  AVG(celebrities.age) AS AverageAge
FROM
  countries
INNER JOIN
  celebrities
